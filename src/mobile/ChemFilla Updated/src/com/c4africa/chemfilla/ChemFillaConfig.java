...
public class ChemFillaConfig extends AsyncTask<String,Integer,String>{
	...
	private void addTopics(){
		myDB.createTopic(1, "Introduction to Chemistry",1);
		myDB.createTopic(2, "Atomic Structure",1);
		myDB.createTopic(3, "Chemical Bonding",1);
		myDB.createTopic(4, "Conservation of Matter and Stoichiometry",1);
		myDB.createTopic(5, "States of Matter",1);
		myDB.createTopic(6, "Energy and Energy Changes",2);
		myDB.createTopic(7, "Inorganic Chemistry",2);
		myDB.createTopic(8, "Chemical Kinetics and Equilibrium",2);
		myDB.createTopic(9, "Acids and Bases",2);
		myDB.createTopic(10, "Redox Reactions and Electrochemistry",2);
		myDB.createTopic(11, "Chemistry of Carbon Compounds",2);
		myDB.createTopic(12, "Chemistry, Industry and Environment",3);
		myDB.createTopic(13, "Basic Biochemistry",3);
	}
