...
public class ChemFillaDB{
	 ...
	 */
	public long createTopic(int id, String name, int year){
		return topic.createEntity(id,name,year,myDatabase);
	}
	...
	public List<topicObj> getTopics(int year){
		return topic.getTopics(year,myDatabase);
	}
