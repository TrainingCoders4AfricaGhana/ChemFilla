...
public class topic {
	...
	public static long createEntity(int id, String name,
	...
	public static List<topicObj> getTopics(SQLiteDatabase myDatabase){
		String[]allColomns={FIELD_ID,FIELD_NAME};
	...
	private static topicObj cursorToTopicObj(Cursor cursor){
		...
		return new topicObj(cursor.getInt(rowId),cursor.getString(rowName));
	}
}